...
class treeexample(Tkinter.Frame):
    ...
    def initialize_tree(self):
        ...
        self.dose_label = Tkinter.Label(self.parent, text="Drive")
        ...
        self.comment_label = Tkinter.Label(self.parent,
                                            text="Volume #")
        self.comment_entry = Tkinter.Entry(self.parent)
        self.comment_label.grid(row=2, column=0, sticky=Tkinter.W)
        self.comment_entry.grid(row=2, column=1)

        self.submit_button = Tkinter.Button(self.parent, text="Format",
                                            command=self.insert_data)
        self.submit_button.grid(row=1, column=3, sticky=Tkinter.W)
        self.submit_button = Tkinter.Button(self.parent, text="Clone...",
        ...
        self.tree.heading('#1', text='Drive #')
        self.tree.heading('#2', text='Volume #')
